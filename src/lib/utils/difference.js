import { derivative, evaluate, or } from "mathjs"
    ...
    const functionList = [
        ...
        [
            ...
            [
                ...
                () => (f(x + 4 * h) - 4 * f(x + 3 * h) + 6 * f(x + 2 * h) - 4 * f(x + h) + f(x)) / (h * h * h * h)
            ],
            // advance
            [
                // order
                ...
                () => (-3 * f(x + 4 * h) + 14 * f(x + 3 * h) - 24 * f(x + 2 * h) + 18 * f(x + h) - 5 * f(x)) / (2 * h * h * h),
                () => (-2 * f(x + 5 * h) + 11 * f(x + 4 * h) - 24 * f(x + 3 * h) + 26 * f(x + 2 * h) - 14 * f(x + h) + 3 * f(x)) / (h * h * h * h)
            ]
        ],
        // backward
        [
            ...
            [
                ...
                () => (f(x) - 4 * f(x - h) + 6 * f(x - 2 * h) - 4 * f(x - 3 * h) + f(x - 4 * h)) / (h * h * h * h),
            ],
            // advance
            [
                // order
                ...
                () => (5 * f(x) - 18 * f(x - h) + 24 * f(x - 2 * h) - 14 * f(x - 3 * h) - f(x - 4 * h)) / (2 * h * h * h),
                () => (3 * f(x) - 14 * f(x - h) + 26 * f(x - 2 * h) - 24 * f(x - 3 * h) + 11 * f(x - 4 * h) - 2 * f(x - 5 * h)) / (h * h * h * h)
            ]
        ],
        // central
        [
            ...
            [
                ...
                () => (-f(x + 3 * h) + 8 * f(x + 2 * h) - 13 * f(x + h) + 13 * f(x - h) - 8 * f(x - 2 * h) + f(x - 3 * h)) / (8 * h * h * h),
                () => (-f(x + 3 * h) + 12 * f(x + 2 * h) - 39 * f(x + h) + 56 * f(x) - 39 * f(x - h) + 12 * f(x - 2 * h) - f(x - 3 * h)) / (6 * h * h * h * h)
            ]
        ]
    ];
