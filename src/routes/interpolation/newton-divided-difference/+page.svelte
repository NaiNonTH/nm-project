<script>
	...
	import { newtonDividedDifference } from '$lib/utils/interpolation.js';
	...
	$: disabled =
		x_data.some((num) => typeof num === 'number') ||
		y_data.some((num) => typeof num === 'number') ||
		filter.size < 2;
	...
	function submit() {
		result = newtonDividedDifference(x, x_filtered, y_filtered);
	}
</script>
